        ...
        >
            ...
            >
                ...
                >
                    ...
                    <Flex flexDir="column" alignItems="center" mb={10} mt={5}>
                        <Avatar my={2} size="lg" src="https://cdn.pixabay.com/photo/2020/08/29/16/08/pikachu-5527377_1280.jpg" />
                        <Text textAlign="center">ARNAV</Text>
                    </Flex>
                </Flex>
            </Flex>
            ...
            >
                <Heading
                    ...
                    letterSpacing="tight"
                >
                    Welcome back, <Flex display="inline-flex" fontWeight="bold">Arnav</Flex>
                </Heading>
                <Text color="gray" fontSize="sm">My Balance</Text>
                <Text fontWeight="bold" fontSize="2xl">$69,420</Text>
                <MyChart />
                <Flex justifyContent="space-between" mt={8}>
                    <Flex align="flex-end">
                        <Heading as="h2" size="lg" letterSpacing="tight">Transactions</Heading>
                        <Text fontSize="small" color="gray" ml={4}>Aug 2021</Text>
                    </Flex>
                                    ...
                                    <Td>
                                        <Flex align="center">
                                            ...
                                            <Flex flexDir="column">
                                                ...
                                                <Text fontSize="sm" color="gray">Aug 1, 2021 at 1:40pm</Text>
                                            </Flex>
                                        </Flex>
                                    </Td>
                                    ...
                                    <Td>
                                        <Flex align="center">
                                            ...
                                            <Flex flexDir="column">
                                                ...
                                                <Text fontSize="sm" color="gray">Aug 2, 2021 at 3:43pm</Text>
                                            </Flex>
                                        </Flex>
                                    </Td>
                                    <Td>Cafe and restaurant</Td>
                                    <Td isNumeric>+$20</Td>
                                    <Td isNumeric><Text fontWeight="bold" display="inline-table">-$11</Text>.00</Td>
                                </Tr>
                                <Tr>
                                    <Td>
                                        <Flex align="center">
                                            ...
                                            <Flex flexDir="column">
                                                ...
                                                <Text fontSize="sm" color="gray">Aug 3, 2021 at 11:23am</Text>
                                            </Flex>
                                        </Flex>
                                    </Td>
                                    <Td>Social Media</Td>
                                        ...
                                        <Tr>
                                            <Td>
                                                <Flex align="center">
                                                    ...
                                                    <Flex flexDir="column">
                                                        <Heading size="sm" letterSpacing="tight">Amazon</Heading>
                                                        <Text fontSize="sm" color="gray">Aug 4, 2021 at 9:40pm</Text>
                                                    </Flex>
                                                </Flex>
                                            </Td>
                                            <Td>Electronic Devices</Td>
                                            <Td isNumeric>+$2</Td>
                                            <Td isNumeric><Text fontWeight="bold" display="inline-table">-$22</Text>.00</Td>
                                        </Tr>
                                        <Tr>
                                            <Td>
                                                <Flex align="center">
                                                    ...
                                                    <Flex flexDir="column">
                                                        <Heading size="sm" letterSpacing="tight">Starbucks</Heading>
                                                        <Text fontSize="sm" color="gray">Aug 5, 2021 at 2:10pm</Text>
                                                    </Flex>
                                                </Flex>
                                            </Td>
                                            <Td>Cafe and restaurant</Td>
                                        ...
                                        <Tr>
                                            <Td>
                                                <Flex align="center">
                                                    ...
                                                    <Flex flexDir="column">
                                                        <Heading size="sm" letterSpacing="tight">YouTube</Heading>
                                                        <Text fontSize="sm" color="gray">Aug 7, 2021 at 9:03am</Text>
                                                    </Flex>
                                                </Flex>
                                            </Td>
                                            <Td>Social Media</Td>
            ...
            >
                        ...
                        <Flex p="1em" color="#fff" flexDir="column" h="100%" justify="space-between">
                            <Flex justify="space-between" w="100%" align="flex-start">
                                <Flex flexDir="column">
                                    ...
                                    <Text fontWeight="bold" fontSize="xl">$69,420</Text>
                                </Flex>
                                <Flex align="center">
                    ...
                    >
                        <Flex p="1em" color="#fff" flexDir="column" h="100%" justify="space-between">
                            <Flex justify="space-between" w="100%" align="flex-start">
                                <Flex flexDir="column">
                                    <Text color="gray.400">Current Balance</Text>
                                    <Text fontWeight="bold" fontSize="xl">$420.00</Text>
                                </Flex>
                                <Flex align="center">
                                    <Icon mr={2} as={FiCreditCard} />
                                    <Text>Rise.</Text>
                    ...
                    >
                        <Flex p="1em" color="#fff" flexDir="column" h="100%" justify="space-between">
                            <Flex justify="space-between" w="100%" align="flex-start">
                                <Flex flexDir="column">
                                    <Text color="gray.400">Current Balance</Text>
                                    <Text fontWeight="bold" fontSize="xl">$69.00</Text>
                                </Flex>
                                <Flex align="center">
                                    <Icon mr={2} as={FiCreditCard} />
                                    <Text>Rise.</Text>
                ...
                <Flex justifyContent="center" mt={2}>
                    <Button bgColor={value == 1 ? "gray.800" : "gray.200"} size="xs" mx={1} onClick={() => changeValue(1)} />
                    <Button bgColor={value == 2 ? "gray.600" : "gray.200"} size="xs" mx={1} onClick={() => changeValue(2)} />
                    <Button bgColor={value == 3 ? "gray.400" : "gray.200"} size="xs" mx={1} onClick={() => changeValue(3)} />
                </Flex>
                ...
                <Text color="gray" mt={4} mb={2}>Tot</Text>
                <InputGroup>
                    <InputLeftElement
                        pointerEvents="none"
                ...
                <Button mt={4} bgColor="blackAlpha.900" color="#fff" p={7} borderRadius={15}>Send CASH</Button>
            </Flex>
        </Flex>
    )
}